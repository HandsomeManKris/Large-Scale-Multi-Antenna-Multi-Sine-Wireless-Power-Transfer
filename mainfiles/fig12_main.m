...
%Vouttotal2(1:ChannelInfoGroup.nKcase,2) = VoutAve1;
%Vouttotal2(1:ChannelInfoGroup.nKcase,1) = VoutAve2;

VouttotalGain1 = VoutAve2./VoutAve1;
VouttotalGain2 = VoutAve4 ./VoutAve3 ;
plot((ChannelInfoGroup.Kcase(1):1:ChannelInfoGroup.Kcase(ChannelInfoGroup.nKcase)),VouttotalGain1,'r-s');hold on
plot((ChannelInfoGroup.Kcase(1):1:ChannelInfoGroup.Kcase(ChannelInfoGroup.nKcase)),VouttotalGain2,'b-o');

xlabel('Number of users');
ylabel('Average v_{out}[mV]');
%set(gca,'xticklabel',{'(8,3)','(8,5)','(8,7)','(8,9)','(16,3)','(16,5)','(16,7)','(16,9)'});
grid on;
legend('N = 8','N = 16','location','northwest')
toc